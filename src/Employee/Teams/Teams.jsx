  ...
  const staticTeams = [
    {
      Id: "T001",
      CEO: "Alice Johnson",
      HR_Manager: "Robert Smith",
      Client_Name: "xxxxxxxxx",
      Team_Name: "Alpha Team",
      Team_Manager: "David",
      Team_Leader: "Anna",
      Team_senior: "Charlie",
      Team_Member: [
        { name: "Tom", designation: "Frontend Developer", attendance: "Present" },
        { name: "Jerry", designation: "Backend Developer", attendance: "ooo" },
        { name: "Nina", designation: "Tester", attendance: "Present" }
      ],
    ...
    },
    {
      ...
      Team_Member: [
        ...
        { name: "Steve", designation: "QA Analyst", attendance: "ooo" },
    ...
    },
    {
      ...
      Team_Member: [
        ...
        { name: "Zack", designation: "Full Stack Developer", attendance: "ooo" }
      ],
